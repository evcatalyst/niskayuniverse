...
describe('Parcel Data Validation', () => {
  ...
  it('should have a reasonable percentage of parcels with year_built', () => {
    ...
    const withYearBuilt = parcels.filter(p => p.year_built !== null && p.year_built !== undefined).length;
    ...
    console.log(`Parcels with year_built: ${withYearBuilt}/${parcels.length} (${percentage.toFixed(1)}%)`);
  });
